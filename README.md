...
The full multi-scale implosion simulation dataset generated by MULTI-2D is hosted on Zenodo.
Download the compressed dataset from our Zenodo repository: 
   [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20052182.svg)](https://doi.org/10.5281/zenodo.20052182)
   *(Direct link:[https://zenodo.org/records/20052182](https://zenodo.org/records/20052182))*
